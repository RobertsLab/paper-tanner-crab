...
```{r}
pheatmap(crab.heatmap, scale = "row", cluster_row = TRUE, cluster_cols = FALSE, clustering_distance_rows = "euclidean", clustering_method = "average", annotation_colors = my_colors, annotation_row = clusters, show_rownames = FALSE, show_colnames = TRUE, treeheight_col = 150, legend = TRUE, color = heatmapBrBG, fontsize_col = 12, fontsize_row = 12)
```
