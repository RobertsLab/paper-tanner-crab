...
List of DEGs associated with infection status while taking temperature treatment into account.     
...
List of DEGs comparing infection status. List includes count data from the four libraries.      
...
List of DEGs comparing infection status. 
