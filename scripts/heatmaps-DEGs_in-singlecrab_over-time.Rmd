...
```{r}
colnames(temp.clust) <- c("Trinity_ID","178","359","463", "temp.degs.single.crab")
head(temp.clust)
```
...
```
Wrote out 09/22/2020. Commented out code. 
