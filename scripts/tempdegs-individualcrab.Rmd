---
title: "fig2 and fig 3 cluster join"
...
```{r}
col_order <- c("Trinity_ID", "380822", "380823", "380824", "380825", "temp.con.fig2", "singlecrab.gene.cluster.Fig3", "V2", "uniprot_acc_ID", "V4", "V5", "V6", "V7", "V8", "V9", "V10", "V11", "V12", "V13", "V14", "Entry.name", "status", "Protein.names", "Geme.names", "Organism", "Length", "Gene.ontology.biological.process", "Gene.ontology.cellular.component", "Gene.ontology.GO", "Gene.ontology.molecular.function", "Gene.ontology.IDs")

temp.degs.single2 <- temp.degs.single[, col_order]
head(temp.degs.single2)
```

Write out table to analyses:
```{r}
#write.table(temp.degs.single2, "../analyses/pheatmap/temp-influenced-infectionDEGs-singlecrab-overtime.tab", sep = '\t', quote = FALSE, row.names = FALSE)
```
Wrote out 9/22/2020. Commented out code. 
