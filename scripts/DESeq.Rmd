...
```{r}
#write.table(inf.sig, "../analyses/DESeq2/DEGlist-infection_influenced-by-temp.tab", sep = "\t", row.names = T, quote = FALSE, col.names = TRUE)
```
Wrote out table 08/12/2020. Commented out code
...
```{r}
#write.table(degs_infONLY_counts_match, "../analyses/DESeq2/DEGlist-infONLY-counts.tab", sep = '\t', quote = FALSE, row.names = FALSE)
```
wrote out 08/12/2020. Comment out code. 
...
Write out list with count data:
```{r}
#write.table(degs_inftemp_counts_match, "../analyses/DESeq2/DEGlist-inf-temp-counts.tab", sep = '\t', quote = FALSE, row.names = FALSE)
```
Wrote out 08/12/2020. Commented out code. 
...
Write out list with count data:
```{r}
#write.table(degs_contrasttemp_counts_match, "../analyses/DESeq2/DEGlist-contrast-temp-counts.tab", sep = '\t', quote = FALSE, row.names = FALSE)
```
wrote out 08/12/2020. commented out code. 
