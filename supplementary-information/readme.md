...
Columns are:        
`Trinity_ID` - contig ID from Trinity assembly        
`380822` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is       
`380823` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is      
`380824` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is      
`380825` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is       
`swissprot` - swissprot      
`uniprot_acc_ID` - uniprot accession ID for the contig    
`gene_id` - gene ID      
`pident` - percentage of identical matches      
...
Columns are:    
`Trinity_ID` - contig ID from Trinity assembly            
`380822` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library          
`380823` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library          
`380824` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library            
`380825` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library              
`cluster` - cluster number that is associated with Fig. 2, tells which cluster the contig was found in in the heatmap         
`swissprot` - swissprot        
`uniprot_acc_ID` - uniprot accession ID for the contig    
`gene_id` - gene ID      
`pident` - percentage of identical matches      
...
Columns are:    
`Trinity_ID` - contig ID from Trinity assembly     
`Day0` - contig counts of the individual crab at day 0, associated with Fig.3 in manuscript      
`Day02` - contig counts of the individual crab at day 2, associated with Fig.3 in manuscript           
`Day17` - tcontig counts of the individual crab at day 17, associated with Fig.3 in manuscript       
`cluster` - cluster assignment of the contigs in Fig.3 heatmap in the manuscrupt     
`swissprot` - swissprot        
`uniprot_acc_ID` - uniprot accession ID for the contig    
`gene_id` - gene ID      
`pident` - percentage of identical matches      
...
`380824` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library            
`380825` - Sequencing ID number from the NWGC, can be cross-referenced with S2 for info on what the pooled library is, contig counts for this library     
`temp.contrast.cluster.Fig2` - cluster assignment of the contig in Fig. 2      
`singlecrab.gene.cluster.Fig3` - cluster assignment of the contig in Fig. 3      
`swissprot` - swissprot        
`uniprot_acc_ID` - uniprot accession ID for the contig    
`gene_id` - gene ID      
`pident` - percentage of identical matches      
